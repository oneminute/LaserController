#ifndef HORIZONTALEDITSLIDER_H
#define HORIZONTALEDITSLIDER_H
...
class QDESIGNER_WIDGET_EXPORT HorizontalEditSlider : public QWidget
{
    Q_OBJECT
...
public:
    HorizontalEditSlider(QWidget *parent = 0);
