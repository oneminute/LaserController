...
public:
    ...
    QSvgRenderer(QSvgNode* node, QObject* parent = nullptr);
...
//    int animationDuration() const;//in seconds
    ...
    QRectF bounds() const;
    void ajustTopLeft(QPointF topLeft);
//    QRectF boundsOnElement(const QString &id) const;
//    bool elementExists(const QString &id) const;
//    QMatrix matrixForElement(const QString &id) const;

    void setNode(QSvgNode* node);

public Q_SLOTS:
//    bool load(const QString &filename);
//    bool load(const QByteArray &contents);
//    bool load(QXmlStreamReader *contents);
    void render(QPainter *p, QSvgExtraStates &states);
//    void render(QPainter *p, const QRectF &bounds, QSvgExtraStates &states);
...
private:
    QSharedDataPointer<QSvgRendererPrivate> d_ptr;
