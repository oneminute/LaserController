...
void LaserControllerWindow::bindWidgetsProperties()
{
    ...
    BIND_PROP_TO_STATE(m_ui->actionOpen, "enabled", false, documentPrimitiveState);
    BIND_PROP_TO_STATE(m_ui->actionOpen, "enabled", false, documentPrimitiveRectState);
    BIND_PROP_TO_STATE(m_ui->actionOpen, "enabled", false, documentPrimitiveEllipseState);
    BIND_PROP_TO_STATE(m_ui->actionOpen, "enabled", false, documentPrimitiveLineState);
    BIND_PROP_TO_STATE(m_ui->actionOpen, "enabled", false, documentPrimitivePolygonState);
    BIND_PROP_TO_STATE(m_ui->actionOpen, "enabled", false, documentPrimitiveTextState);
    BIND_PROP_TO_STATE(m_ui->actionOpen, "enabled", false, documentPrimitiveSplineState);
    // end m_ui->actionOpen
    ...
    BIND_PROP_TO_STATE(m_ui->actionSplineTool, "enabled", true, documentPrimitiveState);
    BIND_PROP_TO_STATE(m_ui->actionSplineTool, "enabled", true, documentPrimitiveRectState);
    BIND_PROP_TO_STATE(m_ui->actionSplineTool, "enabled", true, documentPrimitiveEllipseState);
    BIND_PROP_TO_STATE(m_ui->actionSplineTool, "enabled", true, documentPrimitiveLineState);
    BIND_PROP_TO_STATE(m_ui->actionSplineTool, "enabled", true, documentPrimitivePolygonState);
    BIND_PROP_TO_STATE(m_ui->actionSplineTool, "enabled", true, documentPrimitiveTextState);
    BIND_PROP_TO_STATE(m_ui->actionSplineTool, "enabled", true, documentPrimitiveSplineState);
    ...
    BIND_PROP_TO_STATE(m_ui->actionEditSplineTool, "enabled", true, documentIdleState);
    ...
    BIND_PROP_TO_STATE(m_ui->actionDragView, "enabled", false, documentSelectingState);
    ...
    BIND_PROP_TO_STATE(m_ui->actionDragView, "enabled", false, documentPrimitiveEllipseState);
    BIND_PROP_TO_STATE(m_ui->actionDragView, "enabled", false, documentPrimitiveLineState);
    ...
    BIND_PROP_TO_STATE(m_ui->actionSelectionTool, "checked", false, documentIdleState);
    ...
    BIND_PROP_TO_STATE(m_ui->actionSelectionTool, "checked", false, documentSelectedEditingState);
    BIND_PROP_TO_STATE(m_ui->actionSelectionTool, "checked", true, documentViewDragState);
    ...
    BIND_PROP_TO_STATE(m_ui->actionCloseDocument, "enabled", false, documentPrimitiveState);
    BIND_PROP_TO_STATE(m_ui->actionCloseDocument, "enabled", false, documentPrimitiveRectState);
    BIND_PROP_TO_STATE(m_ui->actionCloseDocument, "enabled", false, documentPrimitiveEllipseState);
    BIND_PROP_TO_STATE(m_ui->actionCloseDocument, "enabled", false, documentPrimitiveLineState);
    BIND_PROP_TO_STATE(m_ui->actionCloseDocument, "enabled", false, documentPrimitivePolygonState);
    BIND_PROP_TO_STATE(m_ui->actionCloseDocument, "enabled", false, documentPrimitiveTextState);
    BIND_PROP_TO_STATE(m_ui->actionCloseDocument, "enabled", false, documentPrimitiveSplineState);
    ...
    BIND_PROP_TO_STATE(m_ui->actionLock, "enabled", false, initState);
    BIND_PROP_TO_STATE(m_ui->actionLock, "enabled", false, documentEmptyState);
    BIND_PROP_TO_STATE(m_ui->actionLock, "enabled", true, documentIdleState);
    BIND_PROP_TO_STATE(m_ui->actionLock, "enabled", true, documentViewDragState);
    BIND_PROP_TO_STATE(m_ui->actionLock, "enabled", false, documentPrimitiveState);
    BIND_PROP_TO_STATE(m_ui->actionLock, "enabled", false, documentPrimitiveRectState);
    BIND_PROP_TO_STATE(m_ui->actionLock, "enabled", false, documentPrimitiveEllipseState);
    BIND_PROP_TO_STATE(m_ui->actionLock, "enabled", false, documentPrimitiveLineState);
    BIND_PROP_TO_STATE(m_ui->actionLock, "enabled", false, documentPrimitivePolygonState);
    BIND_PROP_TO_STATE(m_ui->actionLock, "enabled", false, documentPrimitiveTextState);
    BIND_PROP_TO_STATE(m_ui->actionLock, "enabled", false, documentPrimitiveSplineState);
    // end m_ui->actionLock

    // begin m_ui->actionUnlock
    BIND_PROP_TO_STATE(m_ui->actionUnlock, "enabled", false, initState);
    BIND_PROP_TO_STATE(m_ui->actionUnlock, "enabled", false, documentEmptyState);
    BIND_PROP_TO_STATE(m_ui->actionUnlock, "enabled", true, documentIdleState);
    BIND_PROP_TO_STATE(m_ui->actionUnlock, "enabled", true, documentViewDragState);
    BIND_PROP_TO_STATE(m_ui->actionUnlock, "enabled", false, documentPrimitiveState);
    BIND_PROP_TO_STATE(m_ui->actionUnlock, "enabled", false, documentPrimitiveRectState);
    BIND_PROP_TO_STATE(m_ui->actionUnlock, "enabled", false, documentPrimitiveEllipseState);
    BIND_PROP_TO_STATE(m_ui->actionUnlock, "enabled", false, documentPrimitiveLineState);
    BIND_PROP_TO_STATE(m_ui->actionUnlock, "enabled", false, documentPrimitivePolygonState);
    BIND_PROP_TO_STATE(m_ui->actionUnlock, "enabled", false, documentPrimitiveTextState);
    BIND_PROP_TO_STATE(m_ui->actionUnlock, "enabled", false, documentPrimitiveSplineState);
    // end m_ui->actionUnlock
    ...
    BIND_PROP_TO_STATE(m_ui->actionUndo, "enabled", false, documentPrimitiveState);
    BIND_PROP_TO_STATE(m_ui->actionUndo, "enabled", false, documentPrimitiveRectState);
    BIND_PROP_TO_STATE(m_ui->actionUndo, "enabled", false, documentPrimitiveEllipseState);
    BIND_PROP_TO_STATE(m_ui->actionUndo, "enabled", false, documentPrimitiveLineState);
    BIND_PROP_TO_STATE(m_ui->actionUndo, "enabled", false, documentPrimitivePolygonState);
    BIND_PROP_TO_STATE(m_ui->actionUndo, "enabled", false, documentPrimitiveTextState);
    BIND_PROP_TO_STATE(m_ui->actionUndo, "enabled", false, documentPrimitiveSplineState);
    // end m_ui->actionUndo
    ...
    BIND_PROP_TO_STATE(m_ui->actionMirrorAcrossLine, "enabled", true, documentSelectedState);
    BIND_PROP_TO_STATE(m_ui->actionMirrorAcrossLine, "enabled", false, documentViewDragState);
